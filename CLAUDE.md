...
Cheeko is an AI companion for children (ages 3-16) running on ESP32 devices. The system consists of four main components that work together to provide real-time voice interaction:
...
3. **manager-web** (Vue.js) - Admin dashboard for managing devices, users, models, and content
4. **mqtt-gateway** (Node.js) - Protocol bridge converting MQTT/UDP from ESP32 devices to WebSocket for LiveKit
...
### Manager API Modules
Java packages under `cheeko.modules/`:
...
- `security/` - User auth with Apache Shiro
