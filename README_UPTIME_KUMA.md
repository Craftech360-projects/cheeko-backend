...
- `GET http://192.168.0.67:8004/health`
...
|---|---|---|---|---:|---:|---:|---:|
| 1 | Manager API Health | http | `http://192.168.0.67:8002/toy/health` | 30 | 30 | 2 | 10 |
| 2 | Manager API DB Health | http | `http://192.168.0.67:8002/toy/health/db` | 60 | 30 | 2 | 15 |
| 3 | Manager Web Health | http | `http://192.168.0.67:8001/health` | 60 | 30 | 2 | 10 |
| 4 | MQTT Gateway Health | http | `http://192.168.0.67:8004/health` | 30 | 30 | 2 | 10 |
| 6 | EMQX MQTT Port 1883 | port | `192.168.0.67:1883` | 30 | 30 | 2 | 5 |
| 7 | LiveKit Local Port 7880 | port | `192.168.0.67:7880` | 30 | 30 | 2 | 5 |
...
| 16 | Gemini API Health (Manager API) | http | `http://192.168.0.67:8002/toy/health/deps/gemini` | 3600 | 30 | 2 | 10 |
| 17 | Gemini API Port 443 | port | `generativelanguage.googleapis.com:443` | 3600 | 30 | 2 | 8 |
| 18 | ElevenLabs API Health (Manager API) | http | `http://192.168.0.67:8002/toy/health/deps/elevenlabs` | 3600 | 30 | 2 | 10 |
...
```powershell
curl.exe -i http://192.168.0.67:8002/toy/health
curl.exe -i http://192.168.0.67:8002/toy/health/db
curl.exe -i http://192.168.0.67:8002/toy/health/deps/gemini
curl.exe -i http://192.168.0.67:8002/toy/health/deps/elevenlabs
curl.exe -i http://192.168.0.67:8004/health
```
