...
//         // PTT button is cosmetic - agent uses automatic VAD
//         // RPC calls will fail silently (no handlers registered on agent side)
//         if (isPttStart) {
...
//       } catch (error) {
//         // Suppress "Method not supported" errors - these are expected when agent doesn't have RPC handlers
//         // The agent uses automatic VAD instead of manual PTT control
//         if (error.code === 1400 || error.message?.includes('Method not supported')) {
//           // Silent - this is expected behavior, PTT button is cosmetic
//           return;
//         }
