...
public class AdminApplication {
    ...
    public static void main(String[] args) {
        try {
            System.out.println("DEBUG: Entering AdminApplication.main()");
            ...
            if (activeProfile != null && !activeProfile.isEmpty()) {
                ...
                System.out.println("DEBUG: SPRING_PROFILES_ACTIVE is null or empty");
            }
            ...
            System.err.println("FATAL ERROR: Application crashed in main method!");
            e.printStackTrace();
            System.exit(1);
        }
    }
