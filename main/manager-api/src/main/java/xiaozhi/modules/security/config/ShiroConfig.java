...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager, SysParamsService sysParamsService) {
        ...
        filterMap.put("/device/**/device-mode", "anon"); // Allow anonymous access to query device control mode (manual/auto)
        filterMap.put("/device/device-mode", "anon"); // Allow anonymous access to update device control mode
