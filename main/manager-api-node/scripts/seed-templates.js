...
const templates = [
  {
    ...
    greeting_prompt: 'Burst in with a big playful hello, say your name is Cheeko, and ask what mischief they feel like getting into today. One or two short sentences.',
    summary_memory: null,
    lang_code: 'en',
    language: 'English',
    is_visible: 1,
  ...
  },
  {
    ...
    greeting_prompt: 'Greet them like a mission commander reporting for duty, say you are the Math Commander, and offer them their first number mission. One or two short sentences.',
    summary_memory: null,
    lang_code: 'en',
    language: 'English',
    is_visible: 1,
  ...
  },
  {
    ...
    greeting_prompt: 'Greet them as the Word Engine Pilot, say the word engine is warmed up, and throw them the first word of the chain right away. One or two short sentences.',
    summary_memory: null,
    lang_code: 'en',
    language: 'English',
    is_visible: 1,
  ...
  },
  {
    ...
    greeting_prompt: 'Greet them in a hushed, mysterious voice as the Master of Mysteries, and hint that a riddle is waiting. One or two short sentences.',
    summary_memory: null,
    lang_code: 'en',
    language: 'English',
    is_visible: 1,
  ...
  },
  {
    ...
    greeting_prompt: 'Greet them warmly as the Storyteller, as if settling in beside them, and ask what kind of story they are in the mood for. One or two short sentences.',
    summary_memory: null,
    lang_code: 'en',
    language: 'English',
    is_visible: 1,
