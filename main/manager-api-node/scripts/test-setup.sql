-- Test Setup SQL Script
-- Run this in Supabase SQL Editor to enable full testing
...
-- Insert sample RFID pack
INSERT INTO rfid_pack (pack_name, pack_code, description, language, status)
VALUES ('Test Pack', 'test-pack-001', 'Sample RFID pack for testing', 'en', 1)
ON CONFLICT DO NOTHING;

-- Insert sample RFID card mapping
INSERT INTO rfid_card_mapping (rfid_uid, action_type, action_data, status)
VALUES
    ('04A3B2C1D00000', 'content', '{"message": "Test card 1", "type": "story"}', 1),
    ('04A3B2C1D00001', 'content', '{"message": "Test card 2", "type": "music"}', 1),
    ('04A3B2C1D00002', 'question', '{"prompt": "What is 2+2?"}', 1)
ON CONFLICT DO NOTHING;

-- =====================================================
-- 3. SAMPLE CONTENT (for random music test)
-- =====================================================

-- Insert sample music content
INSERT INTO ai_music (title, artist, category, language, status, sort)
VALUES
    ('Test Song 1', 'Test Artist', 'kids', 'en', 1, 0),
    ('Test Song 2', 'Test Artist', 'nursery', 'en', 1, 1),
    ('Twinkle Star', 'Kids Music', 'lullaby', 'en', 1, 2)
ON CONFLICT DO NOTHING;

-- =====================================================
-- DONE!
-- Run the API tests again after executing this script
-- =====================================================
