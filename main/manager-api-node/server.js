...
// Uncaught exception: print the stack, drain the logger, exit.
// Unhandled rejection: log the reason's stack. See src/utils/crashHandlers.js.
require('./src/utils/crashHandlers').install(logger);
