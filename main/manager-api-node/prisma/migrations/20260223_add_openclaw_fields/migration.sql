...
CREATE TABLE "openclaw_pair_tokens" (
...
CREATE INDEX "idx_pair_token" ON "openclaw_pair_tokens"("token");
CREATE INDEX "idx_pair_token_user" ON "openclaw_pair_tokens"("user_id");
