"""
Manages background audio playback for the Storyteller Agent.
"""
import logging
import asyncio
...
logger = logging.getLogger("storyteller.audio")
...
class AudioController:
    ...
    # Lower values = quieter background music so storyteller voice is clearer
    ...
    async def _play_loop(self, file_path: Path):
        ...
        Using LocalAudioSource to publish to the room.
        """
        try:
            ...
            # BACKGROUND_VOLUME of 0.15 means reduce by about -16 dB
            import math
